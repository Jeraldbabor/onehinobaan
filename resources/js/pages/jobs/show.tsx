...
import { Download, FileText, Briefcase, Calendar, ChevronLeft } from 'lucide-react';
            ...
            <section className="relative h-48 w-full bg-slate-900 text-white">
                ...
                <div className="relative mx-auto flex h-full max-w-7xl flex-col justify-end px-4 py-8 sm:px-6 lg:px-8">
                    <nav className="mb-2 text-sm font-medium text-slate-300">
                        ...
                        <span className="mx-2">/</span>
                        <span className="text-white truncate max-w-[200px] inline-block align-bottom">{job.title}</span>
                    </nav>
            ...
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div className="lg:col-span-2">
                        <Button variant="ghost" asChild className="mb-6 -ml-4 gap-2 text-slate-600">
                            <Link href="/jobs">
                            ...
                            <div className="space-y-4">
                                <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500 pb-4 border-b border-slate-100">
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span>Posted on {job.published_at ? new Date(job.published_at).toLocaleDateString() : 'Recently'}</span>
                                    </div>
                                    <div className="flex items-center gap-1.5">
                                        <Briefcase className="size-4" />
                                        <span>{job.employment_type} / Government</span>
                                    </div>
                                </div>
                                    ...
                                    {job.file_url ? (
                                        <div className="flex flex-col sm:flex-row items-center gap-4">
                                            <div className="flex-1 text-sm text-slate-600">
                                                Please download the official document for complete instructions and requirements.
                                            </div>
                                            <Button className="w-full sm:w-auto gap-2" size="lg" asChild>
                                                <a href={job.file_url} target="_blank" rel="noopener noreferrer" download>
                                        ...
                                        <div className="text-sm text-slate-500 italic">
                                            No downloadable attachment provided for this listing. Please contact the municipal office for more details.
                                        </div>
                                    )}
                                </CardContent>
                            </Card>
